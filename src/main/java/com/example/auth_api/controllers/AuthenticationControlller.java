...
import com.example.auth_api.domains.user.AuthenticationDTO;
import com.example.auth_api.domains.user.LoginResponseDTO;
import com.example.auth_api.domains.user.RegisterDTO;
...
public class AuthenticationControlller {
    ...
    public ResponseEntity register(@RequestBody @Valid RegisterDTO data){
        ...
        User u = new User(data.email(), encryptedPassword, data.role());
